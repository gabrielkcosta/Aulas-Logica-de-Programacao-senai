...
//     peso: keyboard.questionFloat('Digite seu peso: '),
//     altura: keyboard.questionFloat('Digite sua altura: '),              
// };
...
// let senhaDigitada = keyboard.questionInt('Digite sua senha de 4 digitos: ');

// if (senhaDigitada !== conta.senha) {
//     console.log("Senha incorrecta. Operação cancelada.");
// } else {
//     let operacao = keyboard.question('Deseja sacar ou depositar? ');
//     let valor = keyboard.questionFloat(`Qual valor deseja ${operacao}? `);
